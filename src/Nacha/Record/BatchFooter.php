...
class BatchFooter {
	...
	public function __construct() {
		// defaults/optional
		$this->reserved = new StringField('', 6);
	...
	public function setCompanyIdNumber($companyIdNumber) {
		$this->companyIdNumber = new StringField($companyIdNumber, 10);
		return $this;
	}
	public function setMessageAuthenticationCode($messageAuthenticationCode) {
		$this->messageAuthenticationCode = new StringField($messageAuthenticationCode, 19);
		return $this;
	}
