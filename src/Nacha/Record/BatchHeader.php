...
class BatchHeader {
	...
	public function setCompanyDiscretionaryData($companyDiscretionaryData) {
		$this->companyDiscretionaryData = new StringField($companyDiscretionaryData, 20);
		return $this;
	}
	public function setCompanyId($companyId) {
		$this->companyId = new StringField($companyId, 10);
		return $this;
	}
	...
	public function setCompanyDescriptiveDate($companyDescriptiveDate) {
		$this->companyDescriptiveDate = new StringField($companyDescriptiveDate, 6);
		return $this;
	}
	public function setEffectiveEntryDate($effectiveEntryDate) {
		$this->effectiveEntryDate = new StringField($effectiveEntryDate, 6);
		return $this;
	}
	public function setSettlementDate($settlementDate) {
		$this->settlementDate = new StringField($settlementDate, 3);
		return $this;
	}
	...
	public function setOriginatingDFiId($originatingDFiId) {
		$this->originatingDFiId = new StringField($originatingDFiId, 8);
		return $this;
	}
